...
async def run_pipeline(
    ...
    try:
        ...
        extraction_task = asyncio.create_task(node_extraction(initial_state))
        research_task = asyncio.create_task(node_research(initial_state))
        extraction_result, research_result = await asyncio.gather(extraction_task, research_task)
